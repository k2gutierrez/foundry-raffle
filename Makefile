...
contract-json :; forge verify-contract $(RAFFLE_CONTRACT_ADDRESS) src/Raffle.sol:Raffle --etherscan-api-key $(ETHERSCAN_API_KEY) --rpc-url $(SEPOLIA_RPC_URL) --show-standard-json-input > json.json
